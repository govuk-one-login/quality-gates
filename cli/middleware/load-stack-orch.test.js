      ...
      manifest: {
        services: [{
          ...
          automated: [{
            ...
            phase: "pre-merge",
            provider: "GitHub",
            file: ".github/workflows/test.yml", path: "$.jobs.test",
          }],
        }],
      },
    };
      ...
      manifest: {
        services: [{
          ...
          automated: [{
            ...
            file: "config/params.yaml", path: "$[?@.ParameterKey=='X']",
          }],
        }],
      },
    };
      ...
      manifest: {
        services: [{
          ...
          automated: [{
            ...
            phase: "build",
            provider: "Stack Orchestration Tool",
            file: "missing/parameters.json", path: "$[?@.ParameterKey=='X']",
          }],
        }],
      },
    };
      ...
      manifest: {
        services: [{
          ...
          automated: [{
            ...
            phase: "build",
            provider: "Stack Orchestration Tool",
            file: relPath, path: "$[?@.ParameterKey=='TestImageRepositoryUri']",
          }],
        }],
      },
    };
