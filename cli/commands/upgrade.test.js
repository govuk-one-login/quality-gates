...
describe("upgrade command", () => {
  it("upgrades a v0.1.0 manifest in place", () => {
    ...
    assert.match(result.$schema, /v0\.7\.0/);
  });
  ...
  it("skips manifests already at latest version", () => {
    const file = createManifest(TMP, {
      $schema: "https://raw.githubusercontent.com/govuk-one-login/quality-gates/refs/tags/v0.7.0/schemas/schema.json",
  ...
  it("finds manifests recursively in a directory", () => {
    ...
    assert.match(a.$schema, /v0\.7\.0/);
    assert.match(b.$schema, /v0\.7\.0/);
